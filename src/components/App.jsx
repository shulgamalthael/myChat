...
const App = ({ loginnedUser, ws, getClientData, clientData }) => {
    ...
    return(
        <Switch>
            <Route path={`/${loginnedUser}/conversations/${id}`}>
                <Messanger
                    ws={ws}
                    currentCompId={id}
